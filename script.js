window.onload = () => {
  ...
  const COMMANDS = {
    ...
    about: "Hello 👋<br>I'm Haridev P.<br> A 19 year old cybersecurity learner currently living in India.",
    skills: '<span class="code">Skill:</span> Ethical Hacking, Pen-Testing, coding,..<br>',
    education: "Amrita vishwa vidyapeetham coimbatore -Btech cse ,Second year ",
    ...
    contact: "You can contact me on any of following links:<br><a href='https://t.me/Haridevp' class='success link'>Telegram</a>, <a href='https://www.instagram.com/_.haridev__/' class='success link'>Instagram</a>, <a href='https://www.twitter.com/Haridev__P/' class='success link'>Twitter</a>"
  };
